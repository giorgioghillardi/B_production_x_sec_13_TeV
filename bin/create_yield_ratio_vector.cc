  ...
  for(int j=0; j<n_var2_bins; j++)
    {
      ...
      out_file_name = TString::Format(VERSION) + "/ratio/" + ratio_str + "_vector_" + var1_name + "_bins_" + var2_name + "_from_" + bins_str + ".root";

      if(bins == "full")
        out_file_name = TString::Format(VERSION) + "/ratio/" + ratio_str + "_vector_full_bins.root";
